# FaceAttend — OpenCV SFace Attendance System
...
> **Technology decision:** FaceAttend does not use Hugging Face, Transformers, PyTorch, or any Hugging Face model repository. Face recognition is implemented entirely with OpenCV SFace and the required OpenCV model files.
...
FaceAttend v1.0 is complete when this flow works:
